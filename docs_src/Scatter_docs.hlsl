...
#if SUB_CATEGORY == 3  // printDatatypes
        {
            s2h_printTxt(ui, _s, _2, _h, _UNDERSCORE);
            s2h_printTxt(ui, _p, _r, _i, _n, _t);
...
#if SUB_CATEGORY == 5  // crosshair
        {
            float time = S2S_TIME();

            s2h_printTxt(ui, _s, _2, _h, _UNDERSCORE);
            s2h_printTxt(ui, _c, _r, _o, _s, _s);
            s2h_printTxt(ui, _h, _a, _i, _r);
            s2h_printLF(ui);
            s2h_printLF(ui);
